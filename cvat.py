...
class CvatDataset:
    ...
    def has_size(self, image_id):
        return "width" in self._images[image_id] and "height" in self._images[image_id]
    ...
    def has_name(self, image_id):
        return "name" in self._images[image_id]
